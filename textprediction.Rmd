...
A layman will be surprised by the linearity of the relationship in this chart. The x axis is in a log scale which implies that the relation exists and is exponential. As a matter of fact this a well known behaviour called the Zipf's law http://en.wikipedia.org/wiki/Zipf%27s_law   XXXX
...
4. Same for typos.
5. All words will be in lower case. (see 6)
